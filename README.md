...
* **High Efficiency:** Operates at **41.93 GFLOPs** with only **8.61M parameters** (tested on RTX 4070 Ti SUPER), making it significantly faster than Mask R-CNN and comparable to lightweight YOLO models.
